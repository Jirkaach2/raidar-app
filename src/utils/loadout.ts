...
export const ARMOR_PIECES: ArmorPiece[] = [
  ...
  { key: 'heavy.plate.jacket', name: 'Heavy Plate Jacket', icon: 'heavy.plate.jacket', tier: 'heavy',
    slots: ['chest'], layer: 2, dualLayer: true, blocksADS: true, speedPenalty: 0.2, blocksSlots: ['hands'], protection: P(0.75, 0.70, 0.17, -0.67, 0.07, 0.47) },
...
export const RUST_WEAPONS: RustWeapon[] = [
  ...
  { key: 'rifle.sks', name: 'SKS', icon: 'rifle.semiauto', category: 'rifles', damage: 40, headMult: 2.0, type: 'projectile', rpm: 380, effectiveRange: 70, maxRange: 300, minDamageFraction: 0.55, ammoClass: '556' },
  { key: 'lmg.m249', name: 'M249', icon: 'lmg.m249', category: 'rifles', damage: 50, headMult: 2.0, type: 'projectile', rpm: 500, effectiveRange: 75, maxRange: 300, minDamageFraction: 0.55, ammoClass: '556' },
